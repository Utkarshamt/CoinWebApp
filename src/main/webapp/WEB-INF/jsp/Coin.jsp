...
<body>
    ...
    <div class="container">
        ...
        <h1 class="p-3"> Historical Coins</h1>
        ...
        <form:form>
            ...
            <table class="table table-bordered">
            	<tr>
            		...
            		<th>country</th>
            		<th>denomination</th>
            		<th>acquiredYear Completed</th>
            		<th>currentValue</th>
            		<th>yearOfMinting</th>
            	</tr>

            	<c var="coin" items="${coin}">
                    <tr>
                        <td>${coin.id}</td>
                		<td><img src= ${coin.imgUrl} width="300" height="300"></td>
                		<td>${coin.country}</td>
                		<td>${coin.denomination}</td>
                		<td>${coin.acquiredYear}</td>
                		<td>${coin.currentValue}</td>
                		<td>${coin.yearOfMinting}</td>
                	</tr>
        ...
        <button type="button" class="btn btn-danger btn-block">
        	<a href="/deleteCoin/${coin.id}">Delete</a>
        </button>
        <button type="button" class="btn btn-primary btn-block">
        	<a href="/editCoin/${coin.id}">Update</a>
        </button>
